# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2017-03-21 22:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cinematic_moves', models.ManyToManyField(blank=True, related_name='cinematic_moves', to='pgo.Move')),
            ],
            options={
                'ordering': ('number',),
        ...
        migrations.AddField(
            model_name='pokemon',
            name='quick_moves',
            field=models.ManyToManyField(blank=True, related_name='quick_moves', to='pgo.Move'),
        ),
        migrations.AddField(
            model_name='pokemon',
            name='secondary_type',
